          ...
          <div className="space-y-6">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-black leading-[1.1] tracking-tight text-white text-balance">
                Ambientes <span className="text-primary">Únicos</span>
              </h2>
            </div>
            <p className="text-lg md:text-xl text-white/80 max-w-xl leading-relaxed">
              Descubre cómo transformamos espacios ordinarios en ambientes extraordinarios. Llenos de carácter, estilo y funcionalidad. Tu inspiración te espera.
            </p>
