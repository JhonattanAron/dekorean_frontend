        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <img
              ...
              src="https://storage.googleapis.com/dekorans_bucket/products/ChatGPT%20Image%2010%20mar%202026%2C%2013_45_38.png"
            />
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-charcoal/70 dark:text-slate-400 mt-4 text-lg">
                Nuestros paneles están diseñados para ofrecer una experiencia
                sensorial única y una durabilidad excepcional en cualquier
                entorno.
              </p>
            </div>
