...
export function CartModal() {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed top-20 right-4 w-full max-w-md rounded-2xl p-6 border border-white/10 shadow-2xl flex flex-col max-h-[calc(100vh-120px)] z-50 bg-[#212129]/80 backdrop-blur-md">
        {/* Header */}
